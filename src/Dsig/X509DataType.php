...
class X509DataType
{
    ...
    /**
     * @var \Greenter\Ubl\Entity\Dsig\X509IssuerSerialType[] $x509IssuerSerial
     */
     ...
     *
     * @return self
     * @param \Greenter\Ubl\Entity\Dsig\X509IssuerSerialType $x509IssuerSerial
     */
    public function addToX509IssuerSerial(\Greenter\Ubl\Entity\Dsig\X509IssuerSerialType $x509IssuerSerial)
    {
