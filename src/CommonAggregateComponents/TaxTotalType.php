...
class TaxTotalType
{
     ...
     *  Amount. Type
     *
     * @var \Greenter\Ubl\Entity\CommonBasic\RoundingAmount $roundingAmount
     */
     ...
     *  Tax Subtotal
     *
     * @var \Greenter\Ubl\Entity\CommonAggregateComponents\TaxSubtotal[] $taxSubtotal
     */
    private $taxSubtotal = [
     ...
     *  Amount. Type
     *
     * @return \Greenter\Ubl\Entity\CommonBasic\RoundingAmount
     */
     ...
     *  Amount. Type
     *
     * @param \Greenter\Ubl\Entity\CommonBasic\RoundingAmount $roundingAmount
     * @return self
     */
    public function setRoundingAmount(\Greenter\Ubl\Entity\CommonBasic\RoundingAmount $roundingAmount)
    {
     ...
     *
     * @return self
     * @param \Greenter\Ubl\Entity\CommonAggregateComponents\TaxSubtotal $taxSubtotal
     */
    public function addToTaxSubtotal(\Greenter\Ubl\Entity\CommonAggregateComponents\TaxSubtotal $taxSubtotal)
    {
     ...
     *  Tax Subtotal
     *
     * @return \Greenter\Ubl\Entity\CommonAggregateComponents\TaxSubtotal[]
     */
